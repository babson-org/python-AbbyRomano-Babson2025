...
>>>>>>> 15b809ee95d1cf5728b89196a6ad7bef82f80458:classes/week02/wednesday/exercises/q13-q22.ipynb
  ...
  },
  {
   ...
   "source": [
    ...
    "        txt = 'a number for my kingdom'\n",
    "\n",
    "if num1 > 0 and num2 > 0: print('both are positive')\n",
    "elif num1 > 0 or num2 > 0: print('only one number is positive')\n",
    "else: print('both are negative')"
   ]
  },
  {
   "cell_type": "markdown",
